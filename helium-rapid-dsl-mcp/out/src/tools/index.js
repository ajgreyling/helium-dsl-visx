...
export const tools = [
    {
        ...
        description: "Validate a .mez file (parser, lint, semantic). Includes unused-function/units/models when configured; unused .lang keys are reported when validating .lang (diagnostics.unused.languageEntries, default Info). View actions from .vxml are merged from disk when the MCP workspace root is the Helium project folder (e.g. dsl/). Prefer helium_mez_lint for lint-focused workflows.",
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Legacy validation for a .vxml file. Checks structure and cross-file references (units/functions/variables, model attributes, enums, language keys). Prefer helium_vxml_lint for lint-focused workflows.",
        inputSchema: {
            type: "object",
            properties: {
                filePath: { type: "string", description: "Absolute path to the .vxml file." },
    ...
    },
    {
        ...
        description: "Preferred .vxml linting tool. Validates view structure and cross-file references, then returns diagnostics plus a severity summary (errors/warnings/info/hints).",
        inputSchema: {
            type: "object",
            properties: {
                filePath: { type: "string", description: "Absolute path to the .vxml file." },
    ...
    },
    {
        ...
        description: "Start streaming Helium platform debug logs (WSS) and expose them via a local SSE URL, using credentials/appId from helium-rapid-dsl-project.json.",
        inputSchema: {
            type: "object",
            properties: {
...
export async function createToolHandlers() {
