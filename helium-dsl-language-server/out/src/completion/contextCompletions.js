...
exports.buildContextCompletions = buildContextCompletions;
exports.getObjectProperties = getObjectProperties;
const fs = __importStar(require("fs"));
const vscode_uri_1 = require("vscode-uri");
function buildContextCompletions(_table) {
 ...
 */
function getObjectProperties(typeName, workspaceIndex) {
    const definition = workspaceIndex.findObjectDefinition(typeName);
    if (!definition) {
        return [];
    }
    try {
        const filePath = vscode_uri_1.URI.parse(definition.uri).fsPath;
